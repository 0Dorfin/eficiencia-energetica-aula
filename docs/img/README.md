...
| `06_serie_temporal_calefaccion.png` | Temperatura de calefacción real vs. predicha | `notebooks/02_dataset_gold.ipynb` |
| `07_scatter_real_vs_predicho.png` | Dispersión real vs. predicho del modelo lineal | `notebooks/03_regresion_calefaccion.ipynb` |
| `serie_temporal_derroche.png` | Horas de derroche por semana | `notebooks/02_dataset_gold.ipynb` |
| `08_distribucion_target.png` | Distribución del target (73 % / 27 %) | `notebooks/02_dataset_gold.ipynb` |
| `09_curvas_entrenamiento.png` | Train Loss y Val F1 por época (67 épocas) | `notebooks/05_red_neuronal_v2.ipynb` |
| `10_matriz_confusion.png` | Matriz de confusión en test | `notebooks/06_evaluacion.ipynb` |
| `11_curva_roc.png` | Curva ROC, AUC = 0.9660 | `notebooks/05_red_neuronal_v2.ipynb` |
...
| `22_grafana_live_alerta.png` | Estado actual en escenario de invierno: exterior a 7 °C, calefacción encendida, ventanas abiertas y alerta al 75,2 % | Grafana :3001 |
